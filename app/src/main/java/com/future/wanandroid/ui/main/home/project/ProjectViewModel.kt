    ...
    fun getProjectCategory() {
        ...
        launch(
            block = {
                ...
                val pagination = projectRepository.getProjectArticleList(INITIAL_PAGE, cid)
    ...
    fun refresh(checkedPosition: Int = checkedCategory.value ?: INITIAL_CHECKED) {
        ...
        launch(
            block = {
                ...
                val cid = categoryList[checkedPosition].id
                val articleData = projectRepository.getProjectArticleList(INITIAL_PAGE, cid)
    ...
    fun loadMore() {
        ...
        launch(
            block = {
                ...
                val cid = categoryList[checkedPosition].id
                val pagination = projectRepository.getProjectArticleList(page + 1, cid)
                page = pagination.curPage
