...
public class AnimLogoView extends View {
    private static final String DEFAULT_LOGO = "SEAGAZER";  //默认文字
    private static final int DEFAULT_TEXT_PADDING = 10; //默认间距
    private static final int ANIM_LOGO_DURATION = 1500; //动画持续时间
    private static final int ANIM_LOGO_GRADIENT_DURATION = 1500; //变色持续时间
    private static final int ANIM_LOGO_TEXT_SIZE = 30; //文字大小
    private static final int ANIM_LOGO_TEXT_COLOR = Color.BLACK; //文字颜色
    private static final int ANIM_LOGO_GRADIENT_COLOR = Color.YELLOW; //闪烁颜色
